...
import { Button, Flex, Skeleton, Upload, message } from "antd";
...
import { getStudentInfo, setStudentInfo } from "@redux/reducer";
...
const UpLoadStudentCard = memo(
  ({ isFetchingStudentInfo }: { isFetchingStudentInfo: any }) => {
      ...
      <Flex>
        ...
        {isFetchingStudentInfo ? (
          <Skeleton.Image
            ...
            active={true}
          />
        ) : studentInfo.studentCardImage != "" ? (
          <AntdImg
            width={300}
            height={200}
            src={studentInfo.studentCardImage}
